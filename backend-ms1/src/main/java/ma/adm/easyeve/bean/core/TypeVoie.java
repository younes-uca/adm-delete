...
public class TypeVoie   extends AuditBusinessObject     {
    ...
    public TypeVoie(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        TypeVoie typeVoie = (TypeVoie) o;
        return id != null && id.equals(typeVoie.id);
    }
