...
@Component({
  selector: 'app-message-type-edit-admin',
  templateUrl: './message-type-edit-admin.component.html'
})
export class MessageTypeEditAdminComponent extends AbstractEditController<MessageTypeDto, MessageTypeCriteria, MessageTypeService>   implements OnInit {
