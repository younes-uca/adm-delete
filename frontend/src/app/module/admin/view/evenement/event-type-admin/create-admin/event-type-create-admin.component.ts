...
@Component({
  selector: 'app-event-type-create-admin',
  templateUrl: './event-type-create-admin.component.html'
})
export class EventTypeCreateAdminComponent extends AbstractCreateController<EventTypeDto, EventTypeCriteria, EventTypeService>  implements OnInit {
