...
@Component({
  selector: 'app-type-equipement-edit-admin',
  templateUrl: './type-equipement-edit-admin.component.html'
})
export class TypeEquipementEditAdminComponent extends AbstractEditController<TypeEquipementDto, TypeEquipementCriteria, TypeEquipementService>   implements OnInit {
