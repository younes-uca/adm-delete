...
@Component({
  selector: 'app-tele-peayage-create-admin',
  templateUrl: './tele-peayage-create-admin.component.html'
})
export class TelePeayageCreateAdminComponent extends AbstractCreateController<TelePeayageDto, TelePeayageCriteria, TelePeayageService>  implements OnInit {
