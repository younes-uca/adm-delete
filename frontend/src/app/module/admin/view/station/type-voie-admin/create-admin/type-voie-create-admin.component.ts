...
@Component({
  selector: 'app-type-voie-create-admin',
  templateUrl: './type-voie-create-admin.component.html'
})
export class TypeVoieCreateAdminComponent extends AbstractCreateController<TypeVoieDto, TypeVoieCriteria, TypeVoieService>  implements OnInit {
